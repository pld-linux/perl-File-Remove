...
Source:		ftp://ftp.perl.org/pub/CPAN/modules/by-module/File/File-Remove%{version}.tar.gz
...
(
  cd $RPM_BUILD_ROOT%{perl_sitearch}/auto/File/Remove
...
%{perl_sitearch}/auto/File/Remove
